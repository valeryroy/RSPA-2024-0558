...
#### goal: 
- find the coefficients of the expansion $s [1- \nu_1 s + \nu_2 s^2 + \cdots + \mu_M (-s)^M]$ of the polarization $\alpha_{1,1}$ and $\alpha_{2,2}$
#### output file: 
- numoments.dat
#### post-processing: 
...
## Example 2: lens geometry (intersecting disks)
...
#### goal: 
Find the coefficients of the expansion $\lambda [1- \mu_1 \lambda + \mu_2 \lambda^2 + \cdots + \mu_M (-\lambda)^M]$ of the polarization $\alpha_{1,1}$ and $\alpha_{2,2}$.
#### output file: 
"moments.dat" to store the series coefficients.
#### post-processing: 
...
## Example 3: regular polygon geometry
...
#### example:
./polygon  3 19 38 16 18
#### goal: 
Find the coefficients of the expansion $\lambda [1+\mu_1 \lambda + \mu_2 \lambda^2 + \cdots + \mu_M \lambda]$ of the polarization $\alpha_{1,1}$ and $\alpha_{2,2}$ for the polygon geometry.
#### output file: 
"moments.dat" to store the series coefficients.
#### post-processing: 
- run "maple diffpade_polyg" to find a 1st-order DPA of $\text{Im}[\alpha_{1,1}(z)]$ and $\text{Im}[\alpha_{2,2}(z)]$ with $z= -1/(2\lambda) = x+ iy_0$,  $y_0 \ll 1$
